...
class Users(UserManagementModule):
    ...
    def _redirect_after_insert(self, req, record):
        ...
        if row['state'].value() != Users.AccountState.NEW and not record['autogenerate_password'].value():
            ...
            return Document(_("Registration completed"), content=lcg.p(_("You can log in now.")))
        else:
    ...
    def _send_registration_email(self, req, record):
        ...
        if err:
            # This is a critical message (the use is not able to use the
