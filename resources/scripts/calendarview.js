...
//
// This version used in Wiking includes minor modifications by Tomas Cerha
// <cerha@brailcom.org> to allow calendar localization.
...
Calendar.prototype = {
  ...
  update: function(date)
  {
    ...
    date.setDate(1)
    date.setDate(-(date.getDay()) + 1 + Calendar.FIRST_WEEK_DAY)
