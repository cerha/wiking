...
FROM public.cms_session_log AS l LEFT OUTER JOIN public.users AS u ON l.uid = u.uid LEFT OUTER JOIN public.cms_session AS s ON l.session_id = s.session_id;
